...
function eliminar(id){
    ...
    if(con === true){
        window.location= '../../controladores/admin/eliminar.php?id='+id;
    }
}

function recargarUsu(id){
    editando=false;
    window.location= '../../vista/admin/index.php?id='+id;
}
...
function modificarTlf(idT,id){
    ...
    window.location= '../../controladores/admin/modificarTelefono.php?idT='+idT+'&id='+id+'&numeroT='+numero+'&tipoT='+tipo+'&operadoraT='+operadora;
}
