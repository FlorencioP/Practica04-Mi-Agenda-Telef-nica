        ...
        <table class="tg" style="width:100%">
            ...
            ?> 
                <tr>
                    ...
                    <td class="tg-y698"><span style="cursor: pointer" onclick="cambiarRenglon(this,<?php echo $row['tel_id'] ?>,<?php echo $id ?>,<?php echo $idmod ?>)">Modificar</span></td>
                    <td class="tg-y698"><a href='../../controladores/user/elimTelefonoMOD.php?idT=<?php echo $row["tel_id"] ?>+&id=<?php echo $id ?>+&idmod=<?php echo $idmod ?>'>Eliminar</a></td>
                </tr> 
            <?php 
               }
            }
